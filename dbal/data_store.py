...
class _DS(DataStore):
    ...
    # === panedrone:
    #
    #   1) ^^^ "orm_session" is of type "sqlalchemy.orm.Session".
    #   2) closing of "orm_session" is performed automatically, no need to call orm_session.close().
    #      looks like it happens in "scoped_session.registry.remove()".
